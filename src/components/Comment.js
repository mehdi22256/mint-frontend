      ...
      <div className="flex flex-col gap-y-10">
        ...
        <div className="flex flex-col">
          <div className="flex flex-row items-center gap-x-2">
            ...
            <div className="flex flex-col gap-y-1">
              <p className="text-primary text-xl lg:text-xl font-semibold">
                ام حمزة
              </p>
      ...
      <div className="flex flex-row items-center gap-5 mt-10">
        <div className="flex flex-col">
          <form className="flex flex-col gap-2">
            ...
            <button className="bg-primary text-white w-64 md:w-[690px] lg:w-96 xl:w-[1200px] h-10 hover:bg-green-800 rounded-lg mr-[65px] xl:mr-[65px]">
              نشر
            </button>
          </form>
        </div>
